    ...
    <section className="py-24 bg-[var(--background)] relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-8 text-center">
        ...
        <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
          <Link href={localePath("/kontakt", locale)} className="btn-primary inline-flex items-center justify-center gap-2">
        ...
        <div className="mt-12 flex flex-wrap justify-center gap-8 text-sm text-[var(--foreground-muted)]">
          <div className="flex items-center gap-2">
            ...
            {dict.common.cta.trust1}
          </div>
          <div className="flex items-center gap-2">
            <svg className="w-5 h-5 text-[var(--modulo-accent)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
            </svg>
            {dict.common.cta.trust2}
          </div>
          <div className="flex items-center gap-2">
            <svg className="w-5 h-5 text-[var(--modulo-accent)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
            </svg>
            {dict.common.cta.trust3}
          </div>
        </div>
      </div>
    </section>
